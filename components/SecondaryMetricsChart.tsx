...
export default function SecondaryMetricsChart({ data }: SecondaryMetricsChartProps) {
  ...
  return (
    ...
    >
      {/* Encabezado */}
      <div className="bg-slate-50 border-b border-slate-200 p-1 flex-shrink-0">
        <div className="flex items-center gap-1">
          <div className="p-0.5 rounded-lg bg-gradient-to-br from-purple-500 to-purple-600 shadow-md">
