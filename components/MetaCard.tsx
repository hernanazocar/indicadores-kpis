    ...
    >
      <div className="relative bg-gradient-to-br from-slate-800 to-slate-900 rounded-lg overflow-hidden transition-all duration-300 h-full hover:shadow-2xl shadow-xl border-l-4 border-white flex flex-col">
        <div className="p-4 flex-1 flex flex-col">
          {/* Header con título y badge - MÁS GRANDE */}
          <div className="flex items-center justify-between mb-3">
            ...
            <motion.div
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-bold ${badgeConfig.bgColor} ${badgeConfig.textColor} border ${badgeConfig.borderColor} flex items-center gap-1.5 shadow-lg`}
            >
              {badgeConfig.icon}
          ...
          <div className="space-y-2 flex-1 flex flex-col justify-center">
            ...
            {/* Porcentaje de cumplimiento - MÁS GRANDE */}
            {cumplimiento > 0 && (
              <div className="mt-3 pt-3 border-t-2 border-white/20">
                ...
                <div className="mt-2 bg-white/10 h-3 rounded-full overflow-hidden">
                  <motion.div
                    initial={{ width: 0 }}
