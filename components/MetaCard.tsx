        ...
        <div className="p-2.5 flex-1 flex flex-col">
          ...
          <div className="flex items-center justify-between mb-2">
            ...
            <motion.div
              ...
              className={`px-2 py-1 rounded-lg text-[10px] font-bold ${badgeConfig.bgColor} ${badgeConfig.textColor} border ${badgeConfig.borderColor} flex items-center gap-1 shadow-md`}
            >
              {badgeConfig.icon}
          ...
          {/* Valores principales - COMPACTO PARA TV */}
          <div className="space-y-1 flex-1 flex flex-col justify-center">
            ...
            {/* Valor CLP - OPTIMIZADO */}
            <div className="text-lg font-black text-white leading-tight">
              {formatCLP(valueCLP)}
            </div>

            {/* Porcentaje de cumplimiento - COMPACTO */}
            {cumplimiento > 0 && (
              <div className="mt-2 pt-2 border-t border-white/20">
                <div className="flex items-center justify-between mb-1">
                  <span className="text-[10px] font-bold text-slate-300 uppercase">Cumplimiento</span>
                ...
                <div className="mt-1 bg-white/10 h-2 rounded-full overflow-hidden">
                  <motion.div
                    initial={{ width: 0 }}
                  ...
                  >
                    <span className="text-[9px] font-bold text-white">{cumplimiento}%</span>
                  </motion.div>
                </div>
              </div>
            )}
